        ...
        <div class="table-responsive">
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
             ...
             $usuarios = $db->select("services","*",["status_serv" => 1]);
              foreach ($usuarios as $usuario => $usr) {
                ?>
                <tr>
                    <td><?php echo $usr["id_serv"]; ?></td>
                    <td><?php echo $usr["title_serv"]; ?></td>
                    <td><?php echo $usr["description_serv"]; ?></td>
                                    
                    <td>
                        <a href="#" data-id="<?php echo $usr["id_usr"]; ?>">Editar</a> 
                        / <a href="#" data-id="<?php echo $usr["id_usr"]; ?>">Eliminar</a></td>
                </tr>
                <?php
              }
              ?>
        ...
        <div class="table-responsive">
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
             ...
             $comentarios = $db->select("Comments","*");
              foreach ($comentarios as $comentarios => $usr) {
                ?>
                <tr>
                <td><?php echo $usr["id_comm"]; ?></td>
                  <td><?php echo $usr["name_comm"]; ?></td>
                  <td><?php echo $usr["stall_comm"]; ?></td>
                  <td><?php echo $usr["email_comm"]; ?></td>
